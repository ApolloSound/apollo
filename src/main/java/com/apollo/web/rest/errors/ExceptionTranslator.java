...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleTrackNotFoundException(com.apollo.service.exception.TrackNotFoundException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleAlbumNotFoundException(com.apollo.service.exception.AlbumNotFoundException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
            .withType(NOT_FOUND_TYPE)
            .withStatus(NOT_FOUND)
            .with(MESSAGE_KEY, ex.getMessage())
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleBadOwnerException(com.apollo.service.exception.BadOwnerException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleBadFollowerException(com.apollo.service.exception.BadFollowerException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleGenreNotFoundException(com.apollo.service.exception.GenreNotFound ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
            .withType(NOT_FOUND_TYPE)
            .withStatus(NOT_FOUND)
            .with(MESSAGE_KEY, ex.getMessage())
